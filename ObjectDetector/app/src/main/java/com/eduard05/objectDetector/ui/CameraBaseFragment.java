...
public abstract class CameraBaseFragment extends Fragment {
    ...
    private void capturePhoto(){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            contentValues.put(MediaStore.Images.Media.RELATIVE_PATH, "Pictures/Object Detector");
        }
        ...
        imageCapture.takePicture(outputFileOptions, ContextCompat.getMainExecutor(getContext()), new ImageCapture.OnImageSavedCallback() {
            ...
            public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                ...
                successfulTakePicture(
                        namePicture,
                        timestamp,
                        new File(Environment.getExternalStorageDirectory() + "/Pictures/Object Detector", namePicture + ".jpg")
                );
            }
